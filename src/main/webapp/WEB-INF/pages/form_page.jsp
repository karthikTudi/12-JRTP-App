...
<%-- <h3 align="center">${contactId}</h3> --%>

<c:if test="${contactId ne null && !empty contactId}">
		<h3 align="center">${contactId}</h3>
</c:if>

<c:if test="${conupdate ne null && !empty conupdate}">
		<h3  align="center">${conupdate}</h3>
</c:if>

<frm:form action="savedata" modelAttribute="contactsave">
